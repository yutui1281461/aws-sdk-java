...
public class ProcessCredentialsProviderTest {
    ...
    public static void setup() throws IOException {
        String scriptClasspathLocation = Platform.isWindows() ? "" : "/resources/process/linux-credentials-script.sh";
        ...
        try {
            ...
            File scriptFileOnDisk = File.createTempFile("ProcessCredentialsProviderTest", "");
